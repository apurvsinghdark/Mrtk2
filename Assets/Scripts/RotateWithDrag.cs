...
public class RotateWithDrag : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            deltaX = Mathf.Clamp(deltaX, -89f, 90f);
            playerCameraParent.rotation = Quaternion.Euler(deltaX, deltaY, 0);

            //rigidbody.AddTorque (Vector3.down * -deltaY);
            //rigidbody.AddTorque (Vector3.right * deltaX);
